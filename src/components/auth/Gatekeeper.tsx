        ...
        <div className="bg-white rounded-[40px] shadow-2xl shadow-indigo-100 border border-white p-10 flex flex-col items-center">
          ...
          <div className="text-center mb-10">
            <h1 className="text-3xl font-black text-gray-900 tracking-tight mb-2">
              {isDetecting ? "Detectando" : isDenied ? "Acceso" : "Identidad"} <span className="text-indigo-600 font-black">{isDetecting ? "GHL..." : isDenied ? "Denegado" : "Requerida"}</span>
            </h1>
          ...
          {!isDetecting && isDenied && (
            <div className="text-center py-6 px-4 bg-slate-50 rounded-[32px] border border-slate-100 flex flex-col items-center gap-4 animate-in fade-in zoom-in duration-500 w-full">
              <div className="w-16 h-16 bg-rose-50 rounded-2xl flex items-center justify-center text-rose-500 mb-2">
                <AlertCircle size={32} />
              </div>
              <p className="text-sm font-black text-gray-900 leading-relaxed max-w-[240px]">
              ...
              {isIframe && (
                <div className="bg-amber-50/50 border border-amber-200/50 rounded-2xl p-4 flex gap-3 mb-6">
                  ...
                  <div className="text-[11px] leading-relaxed text-amber-800">
                    ...
                    <p className="opacity-80">Si estás en el iFrame de GHL y ves esta pantalla, asegúrate de activar la opción <span className="font-bold">"Pass contact/user info as query params"</span> en la configuración del link de GHL.</p>
                  </div>
                </div>
              )}
